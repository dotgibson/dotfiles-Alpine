...
# The direnv hook and gh completion are initialised by core/zsh/00-tools.zsh (band 00,
# dotfiles-core#449) — the lint gate fails an OS layer that grows its own copy back.
